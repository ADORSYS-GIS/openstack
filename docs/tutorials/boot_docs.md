...
I. **Download the Ubuntu Server ISO Image**
...
II. **Start Ubuntu Server Installation**
...
V. **Choose the Type of Installation**
...
IX. **Select whether to enable Ubuntu Pro**
...
X. **Select Whether to install the OpenSSH server & additional software**
...
XI. **Finish the Installation and Reboot**
