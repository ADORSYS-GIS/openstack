...
On a system using NetworkManager, you often have access to a graphical interface,
...
as Ubuntu Server, where network interface management is more static and does not# Keystone Ansible Automation – Keystone Bootstrap
